...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      dir="rtl"
      className={cn(
        'fixed start-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border bg-card p-6 shadow-lg duration-200 max-h-[90vh] overflow-y-auto rtl:translate-x-1/2',
        className,
      )}
      {...props}
    >
